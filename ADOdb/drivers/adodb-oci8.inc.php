...
";
	...
	{
		return " NVL2($field, $ifNull, $ifNotNull) "; // if Oracle
	}
        ...
        {            
            ...
            return " LISTAGG($field, '$symbol') WITHIN GROUP $sortOrderString ";		
	}
	...
	{
		return " TO_DATE($field, '$format') "; // toDate Oracle
	}
	...
	function UpdateBlob($table,$column,$val,$where,$blobtype='BLOB')
	{
		...
		if (mb_strlen($val) < 4000) return $this->Execute("UPDATE $table SET $column=:blob WHERE $where",array('blob'=>$val)) != false;
