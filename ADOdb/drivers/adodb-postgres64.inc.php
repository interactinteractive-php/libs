...
class ADODB_postgres64 extends ADOConnection{
	...
	var $metaKeySQL = "SELECT ic.relname AS index_name, a.attname AS column_name,i.indisunique AS unique_key, i.indisprimary AS primary_key
        ...
        var $metaKeySQL1 = "SELECT ic.relname AS index_name, a.attname AS column_name,i.indisunique AS unique_key, i.indisprimary AS primary_key
		FROM pg_class bc, pg_class ic, pg_index i, pg_attribute a
		WHERE bc.oid = i.indrelid AND ic.oid = i.indexrelid 
	...
	{
            return " COALESCE(NULLIF($field, $ifNotNull), $ifNull) "; 
	}
...
// Warning: This compilation does not support pg_cmdtuples() in adodb-postgres.inc.php on line 44
	...
	function qstr($s,$magic_quotes=false)
	{
        ...
        {            
            ...
            return " string_agg($field::character varying, '$symbol'$sortOrderString) ";		
	}
        ...
        function trim($field)
	{
        ...
        function groupBy($fileds1, $fileds2 = null) 
        {
            return ' ' . $fileds1 . ' ';
        }
	...
	*/
	...
	{
                $sql = str_ireplace('CONNECT BY NOCYCLE', 'CONNECT BY', $sql);
		$this->_pnum = 0;
		$this->_errorMsg = false;
		if ($inputarr) {
		/*
