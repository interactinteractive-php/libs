...
class Compression extends Controller {
    ...
    public static function decompress($data)
    {
        ...
        if ($compressed === false || $compressed == '' || $compressed == '6' || strpos($compressed, 'aQ') !== false || strpos($compressed, 'aR') !== false || strpos($compressed, 'Q') !== false || !mb_check_encoding($compressed, 'UTF-8')) {
            return $data;
        }
