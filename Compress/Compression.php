...
class Compression extends Controller {
    ...
    public static function decompress($data)
    {
        ...
        if ($compressed === false || $compressed == '' || strpos($compressed, ']R0iQ') !== false || $compressed == '6' || $compressed == '	' || strpos($compressed, '') !== false || strpos($compressed, 'aQ') !== false || strpos($compressed, 'aR') !== false || strpos($compressed, 'Q') !== false || !mb_check_encoding($compressed, 'UTF-8')) {
            return $data;
        }
